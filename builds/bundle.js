...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	    (0, _jquery2.default)("header .heading").typed({
	...
	var tw1 = new _TweenMax2.default.to(".navbar", 0.5, { padding: ".5rem", force3D: true });
	var tw2 = new _TweenMax2.default.to(".nav-item a", 0.5, { padding: "0.4rem 0.6rem", force3D: true });

	var timeline = new TimelineLite().add([tw1, tw2], '+=0', 'start');

	var scene = new _scrollmagic2.default.Scene({
	    offset: 200 }) //.setClassToggle(".navbar", "scrolled")
	.setTween(timeline).addIndicators().addTo(controller);
	...
	var tween = new TimelineMax().add([_TweenMax2.default.fromTo(".img-triangle2", 1, { scale: 3, autoAlpha: 0.05, top: 300 }, { top: -350 })]);

	var scene = new _scrollmagic2.default.Scene({ triggerElement: "#portfolio h1", duration: (0, _jquery2.default)(window).height() }).setTween(tween).addIndicators() // add indicators (requires plugin)
	.addTo(controller);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
		if (typeof define === 'function' && define.amd) {
			...
			factory(__webpack_require__(4), TweenMax, TimelineMax);
		} else {
			// Browser globals
